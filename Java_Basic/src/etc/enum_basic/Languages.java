...
/*
 ...
 1. 상수의 값 자체는 변경이 불가하겠지만, 상수를 받는 객체의 필드 값은 
 안정적이지 못함.
 
 2.상수는 어느 클래스에서나 선언할 수 있기 때문에 무분별한 상수 선언이 이뤄
 질 수 있음. 
...
public enum Languages {
	...
	//상수("연관시킬 문자")
		...
		final private String name;//상수와 연관시킬 문자값을 
		//담을 필드를 선언.
		...
		//위에 선언한 방식의 상수와 연관 문자를 전달해서 name 필드에값을 
		//초기화.
