...
3. 전달되는 값의 타입을 반환 유형이라고 하며, 메서드를 선언할 때
 메서드 이름 앞에 반드시 반환 유형(string , int ..등등)을 명시해야 합니다.
...
7. 이 때는 반환유형을 메서드를 선언할 때 비워두지 마시고
 void라는 키워드를 작성해 주셔야 합니다.// return이 없는 메서드
...
public class MethodExample3 {
	...
	static int[] operateTotal(int n1, int n2){
		...
		//return 밑에 또 다른 return이 들어오면 안된다
		// return은 한 번만 가능
	...
	public static void main(String[] args) {
		...
		int r3 = add(add(4,6),add(7,8));// return이 있는 경우 
		// 다른 매개값으로도 사용가능함 
